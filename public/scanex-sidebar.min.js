var sidebarControl = (function () {
  ...
  let SidebarControl = L.Control.extend({
      ...
      onAdd: function (map) {
          ...
          const tabs = [{ id: 'layers', icon: 'fas fa-layer-group', opened: 'opened', closed: 'closed', content: 'Layers' }, { id: 'weather', icon: 'fas fa-bolt', opened: 'opened', closed: 'closed', content: 'Weather' }, { id: 'services', icon: 'fas fa-cogs', opened: 'opened', closed: 'closed', content: 'Services', enabled: false }];
